        ...
        <div className="container-page grid gap-6 lg:grid-cols-[280px_1fr]">
          ...
          <div className="space-y-6">
            ...
            <section className="card p-5">
              ...
              <p className="mt-2 text-stone-600">
                Tài khoản của bạn không được phép phân quyền, khóa, mở khóa hoặc
                xóa người dùng.
              </p>
            </section>
          </div>
      ...
      <div className="container-page grid gap-6 lg:grid-cols-[280px_1fr]">
        ...
        <div className="space-y-6">
          ...
          <section className="card p-5">
            ...
            <p className="mt-2 text-stone-600">
              Quản trị viên có thể thay đổi vai trò, cập nhật khu vực bỏ phiếu
              được giao, khóa/mở khóa hoặc xóa người dùng.
            </p>
          </section>
